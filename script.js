...
// Hedef doğum günü tarihi (Yıl, Ay (0-11), Gün, Saat, Dakika, Saniye)
var birthday = new Date("2025-03-15T00:00:00");
...
function countdown() {
  ...
  if (difference <= 0) {
    clearInterval(timer);
    document.getElementById("countdown").innerHTML = "Mutlu Yıllar!";
  } else {
